...
class Simulator_GUI:
    ...
    def Menu_testing(self):
        ...
        self.switch_1_L_addr.insert(END, "31")
        self.switch_L_addr.delete('1.0', END)
        self.switch_L_addr.insert(END, "32")
        ...
        self.led_22_L_addr.delete('1.0', END)
        self.led_22_L_addr.insert(END, "41")
        self.led_switch_L_addr.delete('1.0', END)
        self.led_switch_L_addr.insert(END, "42")
        self.led_switch_R_addr.delete('1.0', END)
        self.led_switch_R_addr.insert(END, "43")
        self.led_21_R_addr.delete('1.0', END)
